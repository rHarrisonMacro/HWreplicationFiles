...
%
% This version allows for pure unit roots within the B matrix.
%
% INPUTS:   
...
% Author(s): Matt Waldron and Richard Harrison

% Adjustment to allow for exact unit roots in the reduced form
FRBUSsolTolerance = 1 + 1e-09;
FRBUScondNumber = 1e-15;
...
if any(any(HF))
    [B,~,~,~,~,~,aimcode] = ...
        SPAmalg([HB HC HF],nx,1,1,FRBUScondNumber,FRBUSsolTolerance);
    if aimcode ~= 1
