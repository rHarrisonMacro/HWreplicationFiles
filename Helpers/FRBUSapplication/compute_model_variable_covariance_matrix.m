...
% algorithms.
%
% It adjusts the MAPS version by allowing for failure of the covariance
% computation (potentially because of a pure unit root in the model
% dynamics).
%
% INPUTS:   
...
%
%
% This version: 16/05/2019
% Author(s): Alex Haberis, Matt Waldron & Richard Harison
...
if algorithmIsPrecise
    ...
    try
        ...
        warning(['dlyap failed attempting to compute model covariance ',...
            'matrix. Setting to identity.']);
        P = eye(size(B,1));
    end
end
